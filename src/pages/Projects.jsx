  ...
  const accordions = [
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          description: `Traction substations (TSS), Switching Posts (SP), and Sectioning Posts (SSP) are critical nodes that feed and protect the railway electrification system. CORE4 Engineers specializes in designing and constructing PSI installations that include transformers, circuit breakers, isolators, protection relays, and SCADA-integrated control systems. Our substations ensure stable 25 kV power supply, automatic protection during faults, and reliable feeder switching. Through high-quality equipment and strict safety standards, we support uninterrupted traction power for smooth railway operations.`
        },
        {
    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          image: "/images/Ga9.jpg",
          description: `Solar power plants offer a sustainable and cost-effective solution for industrial and commercial energy needs. CORE4 Engineers provides turnkey solar installation services including design, panel mounting structure, inverter setup, DC/AC cabling, earthing, and grid synchronization. We deliver rooftop and ground-mounted solar plants with high energy output and minimal maintenance. Our solar solutions help clients reduce electricity costs, achieve energy independence, and support environmental sustainability.`
        },
        {
